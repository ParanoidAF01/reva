...
class _StartSubscriptionPageState extends State<StartSubscriptionPage> {
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...[
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(img, height: height * 0.12, width: width * 0.22, fit: BoxFit.cover),
                    ),
                  ))
                ],
              ),
              ...
              child: Column(
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: _selected == 0 ? const Color(0xFF0262AB) : const Color(0xFF22252A),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: _selected == 1 ? const Color(0xFF0262AB) : const Color(0xFF22252A),
                        border: Border.all(color: Colors.white, width: 1.2),
                        borderRadius: BorderRadius.circular(14),
                      ),
                      padding: const EdgeInsets.symmetric(vertical: 18, horizontal: 18),
            ...
            Text(
              ...
              style: GoogleFonts.dmSans(color: Colors.white70, fontSize: 15, fontWeight: FontWeight.w400),
              textAlign: TextAlign.center,
            ),
            SizedBox(height: height * 0.02),
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.dmSans(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 17),
                  ),
                ),
              ),
            ),
  ...
  void _openCheckout() {
    var options = {
      ...
      'name': 'REVA',
      'description': _selected == 0 ? 'Annual Subscription' : 'Monthly Subscription',
      'prefill': {
        'contact': '9123456789',
